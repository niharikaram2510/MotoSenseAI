      ...
      >
        ...
        <View style={styles.greeting}>
          <Text style={styles.greetingTitle}>
            Good afternoon, Pavitraa
          </Text>

          <Text style={styles.greetingSubtitle}>
            {"Here's how your bike is doing today."}
          </Text>
        </View>
        ...
        <View style={styles.sectionCard}>
          ...
          <View style={styles.safetySummary}>
            ...
            <Text style={styles.safetyText}>
              No critical safety events detected today.
            </Text>
          </View>
          ...
          <View style={styles.analyticsMetricCard}>
            <View style={styles.analyticsMetricTop}>
              <View style={styles.blueMetricIcon}>
                <Text style={styles.analyticsIcon}>
                  ⛽
                </Text>
              </View>

              <Text style={styles.analyticsMetricLabel}>
                FUEL LEVEL
              </Text>
            </View>
        ...
        <View style={styles.sectionCard}>
          ...
          <View style={styles.summaryGrid}>
            ...
            <View style={styles.summaryItem}>
              <Text style={styles.summaryIconBlue}>
                ⌖
              </Text>
            ...
            <View style={styles.summaryItem}>
              <Text style={styles.summaryIconGreen}>
                ◷
              </Text>
            ...
            <View style={styles.summaryItem}>
              <Text style={styles.summaryIconYellow}>
                ◉
              </Text>
            ...
            <View style={styles.summaryItem}>
              <Text style={styles.summaryIconPurple}>
                ⛽
              </Text>
          ...
          <View style={styles.breakdownContent}>
            ...
            <View style={styles.breakdownCircle}>
              <View style={styles.breakdownInner}>
                ...
                <Text style={styles.breakdownUnit}>
                  total km
                </Text>
              </View>
            </View>
        ...
        <View style={styles.sectionCard}>
          ...
          <View style={styles.maintenanceContent}>
            ...
            <View style={styles.maintenanceInfo}>
              <Text style={styles.maintenanceSmall}>
                NEXT SERVICE DUE IN
              </Text>
        ...
        <View style={styles.sectionCard}>
          ...
          <View style={styles.insightHeader}>
            <Text style={styles.insightSpark}>
              ✦
            </Text>
          ...
          <View style={styles.insightCard}>
            ...
            <View style={styles.insightText}>
              ...
              <Text style={styles.insightDescription}>
                Your fuel efficiency has improved by 8% this week.
              </Text>
            </View>
          ...
          <View style={styles.insightCard}>
            ...
            <View style={styles.insightText}>
              ...
              <Text style={styles.insightDescription}>
                Keeping a steady speed can improve mileage by up to 15%.
              </Text>
            </View>
          ...
          <View style={styles.insightCard}>
            ...
            <View style={styles.insightText}>
              ...
              <Text style={styles.insightDescription}>
                Smooth braking improves efficiency and riding safety.
              </Text>
            </View>
